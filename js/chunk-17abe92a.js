    ...
    ["chunk-17abe92a"], {
        ...
        a3ba: function(e, t, n) {
            ...
            var r = function() {
                    ...
                    return n("el-container", {
                    ...
                    }, [e._v("缠")])]), n("h2", [e._v("缠论买卖点筛选器")])]), n("div", {
                        staticClass: "form"
                    }, [n("el-input", {
                    ...
                    }, [e._v("从自选表导入自定义股票池")])], 1), n("el-tab-pane", {
                        attrs: {
                            label: "国内期货",
                            name: "futures"
                        }
                    ...
                    }, [e._v("免责声明: 本站数据仅供量化研究参考，不构成买卖建议，产生的收益和损失与本站无关。市场有风险，交易需谨慎! ")])], 1)]), n("el-main", {
                        staticClass: "content"
                        ...
                        nativeOn: {
                            click: function(t) {
                                return e.open("/plugin/壹缠浏览器插件安装说明.pdf")
                            }
                        }
                    }), n("el-step", {
                        attrs: {
                        ...
                        staticClass: "bold"
                    }, [e._v("使用说明")]), n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("使用权限")]), e._v(" - 买卖点选股器仅限于壹缠SVIP用户开放 "), n("el-tooltip", {
                        staticClass: "item",
                        attrs: {
                            effect: "dark",
                            content: "",
                    ...
                    }), n("br"), n("br"), e._v("请微信联系客服")]), n("el-link", {
                        staticClass: "link",
                        attrs: {
                            type: "primary",
                            underline: !1,
                    ...
                    }, [e._v("开通壹缠SVIP服务")])], 1), e._v(" 获得授权KEY。 ")], 1), n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("聚宽数据支持")]), e._v(" - 选股量化数据支持来源于聚宽-JQData本地量化数据, 提供6个月免费数据服务, 每日限额为 "), n("el-tooltip", {
                        staticClass: "item",
                        attrs: {
                            effect: "dark",
                            content: "请求1000根K线 数量计为1000条目, 使用过程中注意避免频繁重复操作选股",
                            placement: "top-start"
                        }
                    }, [n("span", {
                        staticClass: "bold"
                    }, [e._v("100万条目请求")])]), e._v(" , 访问 "), n("el-tooltip", {
                        staticClass: "item",
                        attrs: {
                            effect: "dark",
                            placement: "top-start"
                        ...
                        slot: "content"
                    }, [e._v("从三行代码开始，帮助你定制一套能在本地调用的全品种量化数据")]), n("el-link", {
                        staticClass: "link",
                        attrs: {
                            type: "primary",
                            underline: !1,
                    ...
                    }, [e._v(" 聚宽-JQData本地量化数据 ")])], 1), e._v(" 填写相关信息注册提交后权限会立刻开通。 ")], 1), n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("候选标的池")]), e._v(" - 股票候选标的池提供上证50&沪深300&中证500指数成分股、申万一级行业板块成分股、概念板块成分股, 可以通过三个标的池多条件的交集或并集组合，筛选出适合当下交易的标的池。期货候选标的池以期货交易所分类。 ")]), n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("自定义标的池")]), e._v(" - 除候选标的池外, 可以输入标的简称或代码，搜索相关标的加入标的池，此类标的不参与交集/并集筛选，默认添加到标的池中。 ")]), n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("周期级别")]), e._v(" - 支持单周期缠论分析（如日线）和多周期组合缠论分析（如 5分、30分、日线），最多指定三个周期组合分析(避免请求K线过多，触发聚宽每日限额)。 ")]), n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("交集&并集筛选")]), e._v(" - 交集筛选即仅筛选出同时满足A条件、B条件、C条件的标的（如筛选 属于沪深300成分股 且 属于银行行业的标的）。并集筛选即将满足A条件的标的集合和满足B条件的标的集合合并（如筛选 属于银行板块 或 属于券商板块的标的）。 ")]), n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("缠论分析")]), e._v(" - 根据用户选择的多条件构建成临时的标的池，逐一拉取K线数据，分析走势结构，判断买卖点，结果逐一显示在右侧表格。(注意临时标的池数量不建议超过50个) ")]), n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("结果展示")]), e._v(" - 缠论分析结果展示在表格中， 点击缠论买卖点列表头，可以对缠论买卖点进行筛选，支持筛选出匹配缠论的三大类买卖点的标的。点击买卖点分析结果，支持直接跳转到壹缠看盘页面，方便确认和分析。 ")]), n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("K线差异")]), e._v(" - 选股器数据来源和分析工具为不同数据源, 不同平台数据源提供的K线(尤其小级别)可能有细微差异, 个别情况下缠论分析处理中可能导致最小的笔出现差异, 从而买卖点出现不一致问题, 需进一步看图分析走势对买卖点进行确认。 ")])]), n("ul", {
                        staticClass: "text statement"
                    }, [n("li", [n("span", {
                        staticClass: "bold"
                    }, [e._v("使用需知")])]), n("li", [e._v(" 壹缠服务依赖于壹缠浏览器插件, 支持覆盖主流浏览器 "), n("img", {
                        staticStyle: {
                    ...
                    }, [e._v("壹缠浏览器插件安装说明.pdf")]), e._v(", 安装过程客服会全程协助。 ")], 1), n("li", [e._v(" 壹缠服务不收集任何用户信息, 聚宽账户信息仅限存储于本地, 用于量化数据请求。 ")]), n("li", [e._v(" 壹缠服务仅限基于缠论的量化技术研究,买卖点为缠论量化结果，仅用于交易参考，不构成买卖建议。市场有风险，交易需谨慎! ")])])], 1), e.targets.length ? e._e() : n("div", {
                    ...
                    }, [e._v("Neil Pan")]), e._v(" 建议PC访问")], 1)], 1)], 1), n("div", {
                        ...
                        staticClass: "copyright"
                    }, [e._v("请使用PC浏览器访问 (1280*1024以上分辨率)")])])], 1)
                },
                i = [],
            ...
            var ee = window.top.__Walle_Devtools,
                te = {
                    ...
                    mounted: function() {
                        this.load(), this.key = this.$route.query.key || this.key || "", this.$route.query.key || J["a"].verify(this.key), J["a"].isSVip() || J["a"].notification("缠论买卖点筛选器 需开通SVIP服务 请联系客服微信")
                    },
                    methods: {
                                ...
                                return f.a.wrap((function(n) {
                                    while (1) switch (n.prev = n.next) {
                                        case 0:
                                            ...
                                            return l.a.info("聚宽账户信息缺失"), n.abrupt("return");
                                        case 5:
                                        ...
                                        case 10:
                                            ...
                                            return l.a.info("不存在满足此多条件的标的 请修改筛选条件"), n.abrupt("return");
                                        case 15:
                                ...
                                return f.a.wrap((function(t) {
                                    while (1) switch (t.prev = t.next) {
                                        case 0:
                                            ...
                                            return l.a.info("壹缠授权KEY为空"), t.abrupt("return");
                                        case 3:
                                            if (e.user.mobile && e.user.password) {
                                                t.next = 6;
                                                break
                                            }
                                            return l.a.info("聚宽账户信息缺失"), t.abrupt("return");
                                        case 6:
                                            if (Z["a"].setAccount(e.user.mobile, e.user.password), J["a"].isSVip()) {
                                                t.next = 10;
                                                break
                                            }
                                            return J["a"].notification("缠论买卖点筛选器 需开通SVIP服务 请联系客服微信"), t.abrupt("return");
                                        case 10:
                                            if (e.codes.length) {
                                                t.next = 13;
                                                break
                                            }
                                            return l.a.info("标的池为空 请修改筛选条件"), t.abrupt("return");
                                        case 13:
                                            if (e.levels.length) {
                                                t.next = 16;
                                                break
                                            }
                                            return l.a.info("请选择周期级别"), t.abrupt("return");
                                        case 16:
                                            if (!(e.codes.length >= 50)) {
                                                t.next = 25;
                                                break
                                            }
                                            return t.prev = 17, t.next = 20, o.a.confirm("当前标的池标的数量(".concat(e.codes.length, ")过多 数据请求时间较长且聚宽查询限额容易耗尽 是否继续?"), "", {
                                        ...
                                        case 41:
                                            h = t.sent, u.price = c.close, u.change = 1 === +c.paused ? "停牌" : ((c.close - c.pre_close) / c.pre_close * 100).toFixed(2) + "%", u.trades = h, t.next = 55;
                                            break;
                                        case 47:
                                ...
                                return f.a.wrap((function(n) {
                                    while (1) switch (n.prev = n.next) {
                                        case 0:
                                            ...
                                            return l.a.info("自选表不存在标的"), n.abrupt("return");
                                        case 5:
                                ...
                                return f.a.wrap((function(n) {
                                    while (1) switch (n.prev = n.next) {
                                        ...
                                        case 3:
                                            ...
                                            return l.a.info("请先填入聚宽账户信息"), n.abrupt("return");
                                        case 6:
                        ...
                        filterOfTrades: function(e, t) {
                            var n = +["一", "二", "三"].indexOf(e[0]) + 1 + "",
                                r = e.includes("买") ? "up" : "down";
                        ...
                        tableRowClassName: function(e) {
                            var t = e.row;
                            e.rowIndex;
                            return "停牌" === t.change || "" === t.change ? "" : t.change.replace("%", "") >= 0 ? "search-content-row-red" : "search-content-row-green"
                        },
